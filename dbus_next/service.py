...
def method(name: str = None, disabled: bool = False):
    ...
    The decorated method may raise a :class:`DBusError <asyncdbus.DBusError>`
...
def dbus_property(access: PropertyAccess = PropertyAccess.READWRITE,
    ...
    <asyncdbus.DBusError>` to return an error to the client.
...
class ServiceInterface:
    ...
    <asyncdbus.service.signal>` decorators to mark class methods as DBus
